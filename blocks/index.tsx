...
export default function ExampleFileBlock(props: FileBlockProps) {
  ...
  const [currentStyle, setCurrentStyle] = useState(availableStylesheets[selectedIndex]);
    ...
    return (
      <Box p={4}>
        <Flash variant="danger">
          We could not identify the language in the file. It's contents are displayed as-is for now.
        </Flash>
        <Box
          marginTop={5}
